 ...
 */
#if EFM8BB1_SUPPORT_WT0124_PROTOCOL == 1
#define WT0124
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(WT0124)[], static uint16_t, SI_SEG_CODE) = { 10000, 5000, 1900, 1000, 680, 710 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(WT0124)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(WT0124)[], static uint8_t, SI_SEG_CODE) = { HIGH(2), LOW(3) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(WT0124)[], static uint8_t, SI_SEG_CODE) = { HIGH(4), LOW(5) };
#endif
...
SI_SEGMENT_VARIABLE(PROTOCOL_DATA[], static struct BUCKET_PROTOCOL_DATA, SI_SEG_CODE) =
{
     ...
     */
    {
      { &PROTOCOL_BUCKETS(WT0124), ARRAY_LENGTH(PROTOCOL_BUCKETS(WT0124)) },
      { &PROTOCOL_START(WT0124), ARRAY_LENGTH(PROTOCOL_START(WT0124)) },
      { &PROTOCOL_BIT0(WT0124), ARRAY_LENGTH(PROTOCOL_BIT0(WT0124)) },
      { &PROTOCOL_BIT1(WT0124), ARRAY_LENGTH(PROTOCOL_BIT1(WT0124)) },
      { NULL, 0 },
      48
    },
#endif
